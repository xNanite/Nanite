...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    QFontDatabase::addApplicationFont(":/fonts/segoeuii");
    QFontDatabase::addApplicationFont(":/fonts/seguisb");
    setWindowTitle(tr("Nanite") + " " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { background:#1f1f1f; font-family:'Segoe UI'; } #toolbar2 { border:none;width:30px; background:#1bbae1; }");
#ifndef Q_OS_MAC
    ...
    actionConvertCurrency->setToolTip("Click here to convert your Nanite to USD and BTC.  Nanite price is pegged to BTC/XNAN market and BTC/USD market on Coinbase.");
...
void BitcoinGUI::createActions() {
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/null"), tr("&Send Nanite"), this);
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    toolbarsend2->addAction(sendCoinsAction);
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/null"), tr("&Receive Nanite"), this);
...
void BitcoinGUI::createToolBars() {
    ...
    toolbar->setStyleSheet("#toolbar { font-weight:600;height:100%;padding-top:20px; background-color:#1f1f1f; text-align: left; color:#829091; min-width:180px;max-width:180px;} QToolBar QToolButton:hover {background-color:transparent; color:#1bbae1;} QToolBar QToolButton:checked {background-color:transparent; color:#1bbae1;}  QToolBar QToolButton { font-weight:600;font-size:10px;font-family:'Century Gothic';padding-left:20px;padding-right:181px;padding-top:4px;padding-bottom:4px; width:100%; color:white; text-align: left; background-color:transparent; text-transform:uppercase; }");
